...
![image-20260215132113293](assets/image-20260215132113293.png)

### 创建提示词

![image-20260215132150389](assets/image-20260215132150389.png)

### 左侧导行栏

点击就会在右侧显示对应分类的提示词

![image-20260215132407469](assets/image-20260215132407469.png)

### 导入导出功能

导出功能，可以把在插件中保存的提示词进行导出，方便在切换电脑环境后，可以把保存的提示词进行导出使用

![image-20260215132437032](assets/image-20260215132437032.png)

![image-20260215132610055](assets/image-20260215132610055.png)

导入时选择导出的json文件即可

![image-20260215132639439](assets/image-20260215132639439.png)
